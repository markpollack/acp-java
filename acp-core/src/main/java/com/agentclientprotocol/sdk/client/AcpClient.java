...
public interface AcpClient {
	 ...
	 */
	static AsyncSpec sync(AcpClientTransport transport) {
	...
	class AsyncSpec {
		...
		/**
		 * Creates an instance of {@link AcpSyncClient} that wraps an async client for
		 * blocking operations.
		 * @return a new instance of {@link AcpSyncClient}
		 */
		public AcpSyncClient buildSync() {
			return new AcpSyncClient(build());
		}
